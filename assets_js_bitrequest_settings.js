...
function backupdatabase() {
   ...
   const gd_on = (gd_pass().pass) ? true : false,
       ...
       alert_text = (num_changes === "!") ? 
           ...
           "<p>" + translate("nrchanges", {"nr_changes": num_changes}) + "</p>",
...
function restorebackup() {
   $(document).on("change", "#fileupload", function(n) {
       ...
       popnotify("error", translate("filetype", {"filetype": type}));
   });
}
...
function complement_apisettings(thisref, thisvalue) {
    ...
    const settings = {
        bitly: {"url_shorten_settings": {"bitly_at": thisvalue}},
        firebase: {"url_shorten_settings": {"fbapikey": thisvalue}},
        coinmarketcap: {"cmcapisettings": {"cmcapikey": thisvalue}},
        fixer: {"fiatapisettings": {"fxapikey": thisvalue}}
    };

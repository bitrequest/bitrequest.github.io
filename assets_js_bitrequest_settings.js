    ...
    $(document).on("click", "#share_bu", function() {
        ...
        if (result) {
            ...
            api_proxy({
                ...
                shorten_url(title, glob_const.approot + "?sbu=" + data, fetch_aws("img_system_backup.png"), true);

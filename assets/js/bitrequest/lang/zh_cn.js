...
const lang_zh_cn_obj = {
        ...
        // confirm
        "openurl": "打开{url}？",
        "showrequestsfor": "显示{address}的请求？",
        "areyousure": "您确定吗？",
        "openinvoice": "打开Invoice：{hash}？",
        "sharefile": "分享{filename}？",
        // dialog
        "nofetchtokeninfo": "无法获取代币数据。",
        "archiverequest": "存档请求？",
        "unarchiverequest": "取消存档？",
        "failedtofetchrequest": "无法获取请求",
        "downloadwallet": "下载{currency}钱包",
        ...
        "to": "至",
        "nodetection": "未检测到付款",
        "lookuppayment": "在{blockexplorer}上查找最近的{currency}收入",
        "dontshowagain": "不再显示",
        "dismiss": "关闭",
        ...
        "sharelockttext": "此地址有一个<span id='view_pending_tx' class='linkcolor' data-requestid='{pending_requestid}'>待处理的已分享请求</span>。",
        ...
        "zoo": "动物园",
        // notifications
        "failedhistoric": "无法获取{ccsymbol}历史价格数据",
        ...
        "successshare": "分享成功！",
        // confirm
        "opencoinsettings": "打开{currency}设置？",
        "viewpendingrequest": "查看待处理请求？",
        "useinstead": "改用'{thisinputvalue}'？",
        "generatenewaddress": "确定要生成新的{currency}地址吗？部分钱包可能无法显示",
        // dialog
        "undefinedaddress": "地址未定义，请重新发送请求",
        "invalidaddress": "无效的{payment}地址",

        // SHARE REQUEST
        "share": "分享",
        "sharetitlename_own": "您好，我创建了一个{pagenameccparam} Bitrequest收款请求，金额为{amount} {uoa}，用途：'{requesttitle}'",
        "sharetitlename_sent": "{requestname}发送了一个{pagenameccparam} Bitrequest收款请求，金额为{amount} {uoa}，用途：'{requesttitle}'",
        "sharetitle": "{pagenameccparam}收款请求，金额{amount} {uoa}",
        "sharetitlechange": "{payment}请求，金额{newccvalue} {newccsymbol}",
        ...
        "security": "安全",
        "pinsettings": "PIN锁",
        "bip39_seedphrase": "助记词",
        "missingkeywarning": "'<span class='adspan'>{address}</span>'的{seedstrtitle}缺失。<br/>确定要使用此地址吗？",
        "emptyphrase": "请输入您的助记词",
        "notinwordlist": "{missing_word}不在词库中",
        ...
        "nrchanges": "您的应用有{nr_changes}项更改，请备份您的数据。",
        "changein": "项更改于",
        "changesin": "项更改于",
        "systembackup": "系统备份",
        "downloadbu": "下载备份",
        ...
        "api_proxy": "API代理",
        "updateproxy": "请更新您的代理服务器 {version} > {proxy_version}",
        "addapiproxy": "添加API代理",
        ...
        "teaminviteharetitle": "来自{accountname}的Bitrequest团队邀请",
        "teamupdate": "团队更新",
        "invitationexpiresin": "邀请过期时间",
        "installcompleted": "安装已完成！",
        "teamup": "{account}邀请您一起协作并共同创建收款请求！",
        "teamupdata": "{account}希望您使用最新的公钥更新Bitrequest",
        "clickinstall": "点击安装后，Bitrequest将使用{account}的公钥和受限访问权限安装到您的设备上。",
        // notifications
        "nameisrequired": "姓名为必填项",
        "currencysaved": "货币已保存",
        "currencynotsupported": "不支持货币'{currency}'",
        "noiosbu": "iOS应用下载暂不可用",
        "downloaded": "{file}已下载",
        "filesize": "文件过大",
        "filetype": "不支持文件类型'{filetype}'",
        "selectbackup": "选择备份文件",
        "unauthorized": "未授权",
        ...
        "unabletopost": "无法从{fixed_url}发送Post请求",
        "invalidapikey": "无效的API密钥",
        "apicallerror": "API调用错误",
        "invalidapikeyname": "无效的{thisref} API密钥",
        "addapikey": "添加{apisrc} API密钥",
        "phname": "姓名",
        "phaddress": "地址",
        "phzipcode": "邮编",
        "phcity": "城市",
        ...
        "restorefile": "恢复：{file}？",
        "restorefromdevice": "从{device}设备恢复{file}？",
        ...
        "apis": "APIs",
        "addapi": "添加{h_hint} RPC：",
        "websockets": "Websockets",
        "addwebsocket": "添加{h_hint} Websocket：",
        "layer2": "二层网络",
        "Xpub": "Xpub",
        "bip32xpub": "BIP32扩展公钥",
        "addxpub": "添加{currency} Xpub密钥",
        "xpubmatch": "以上地址与我的{currency}钱包中的地址一致。",
        ...
        "invalidxpub": "不是有效/支持的{currency} Xpub密钥",
        "xpubsaved": "Xpub已保存",
        "resetnotify": "{currency}设置已恢复默认",
        // confirm
        "reusewarningalert": "确定要生成新的{thiscurrency}地址吗？部分钱包可能无法显示。",
        "reusealert": "确定要重复使用{thiscurrency}地址吗？",
        "confirmremovenode": "确定要移除'{thisval}'吗？",
        "disablexpub": "禁用Xpub地址派生？",
        "replacexpub": "替换Xpub？",
        "uselegacy": "使用{thiscurrency} Legacy地址？",
        "usesegwit": "使用{thiscurrency} SegWit地址？",
        "resetconfirm": "确定要重置{currency}设置吗？",
        // dialog
        "resetdialog": "重置{currency}设置？",
        ...
        "enterlnapikey": "输入代理API密钥以解锁'{proxy}'",
        "viewinvoice": "查看Invoice",
        "noinvoicesfound": "未找到Invoice。",
        "invoiceslocked": "节点代理已锁定，无法获取Invoice。<br/>请输入您的代理<span id='pw_unlock_invoices' data-pid='{proxy_id}' class='ref'>API密钥</span>。",
        "invoiceoffline": "节点离线，无法获取Invoice。",
        // notifications
        "nodenotfound": "未找到节点",
        "proxynotfound": "未找到代理",
        "enterserver": "请输入服务器地址",
        "defaultproxy": "{fixed_url}是默认代理",
        "proxyexists": "代理已添加",
        "invalidurl": "无效的URL",
        "selectimplementation": "选择实现方式",
        "selectlnhost": "选择{imp}主机",
        "selectkeyname": "选择{impkeyname}",
        "entermacaroon": "请输入'invoice' Macaroon",
        "invalidkeyformat": "无效的密钥格式",
        "proxylocked": "当前节点代理已锁定，请输入API密钥",
        "proxyoffline": "当前节点离线，请尝试{proxy_message}代理",
        "folderpermissions": "无法写入缓存，请检查文件夹权限。",
        "proxyadded": "代理已添加",
        "unabletoconnectto": "无法连接到{value}",
        "proxynameexists": "{imp}节点已添加",
        "proxyinuse": "{imp}：'{name}'正在使用此代理，请先移除",
        "proxyremoved": "代理已移除",
        ...
        "disableproxy": "禁用代理{set_proxy_val}？",
        "enableproxy": "启用代理{set_proxy_val}？",
        // dialog
        ...
        //DIALOGS
        "totalchanges": "您的应用有{total_changes}项更改",
        "nochanges": "您的应用有0项更改",
        "havewallet": "您的设备上有{lnd_ref}钱包吗？",
        ...
        "connecttolnur": "正在连接{url}",
        "loadurl": "正在加载{url}",
        "loading": "加载中...",
        "gettokeninfo": "获取代币信息",
        "checklightningstatus": "检查{imp} Lightning状态",
        "readingfromcache": "从缓存读取{ccsymbol}汇率",
        "getccrates": "从{api}获取{ccsymbol}汇率",
        "getfiatrates": "获取法币汇率",
        "readingfiatratesfromcache": "从缓存读取法币汇率",
        "fetchingfiatrates": "从{fiatapi}获取法币汇率",
        "generatelink": "正在生成链接",
...
function lang_zh_cn(id, data) {
    return lang_tl(lang_zh_cn_obj, id, data);
}

...
const lang_en_obj = {
        ...
        "entercoinaddress": "Enter a {currency} address.",
        ...
        "novalidaddress": "is NOT a valid {currency} address.",
        ...
        // confirm
        "openurl": "Open {url}?",
        "showrequestsfor": "Show requests for {address}?",
        "areyousure": "Are you sure?",
        "openinvoice": "Open invoice: {hash}?",
        "sharefile": "Share {filename}?",
        // dialog
        ...
        "noaddressyet": "I don't have a {currency} address yet",
        ...
        "lookuppayment": "Look for recent incoming {currency} payments on {blockexplorer}",
        ...
        "sharelockttext": "This address has a <span id='view_pending_tx' class='linkcolor' data-requestid='{pending_requestid}'>pending shared request</span>.",
        ...
        "zoo": "Zoo",
        // notifications
        "failedhistoric": "Failed to get historical {ccsymbol} price data",
        ...
        "latincharacters": "Only letters (A-Z), numbers, and symbols allowed",
        "successshare": "Successful share!",
        // confirm
        "opencoinsettings": "Open {currency} settings?",
        "viewpendingrequest": "View pending request?",
        "useinstead": "Use '{thisinputvalue}' instead?",
        "generatenewaddress": "Are you sure you want to generate a new {currency} address? It may not show up in some wallets",
        // dialog
        "undefinedaddress": "Undefined address, please ask for a new request",
        "invalidaddress": "Invalid {payment} address",

        // SHARE REQUEST
        "share": "share",
        "sharetitlename_own": "Hi, I made a {pagenameccparam} bitrequest of {amount} {uoa} for '{requesttitle}'",
        "sharetitlename_sent": "{requestname} sent a {pagenameccparam} bitrequest of {amount} {uoa} for '{requesttitle}'",
        "sharetitle": "{pagenameccparam} payment request for {amount} {uoa}",
        "sharetitlechange": "{payment} request for {newccvalue} {newccsymbol}",
        ...
        "bip39_seedphrase": "Secret Phrase",
        "missingkeywarning": "{seedstrtitle} for '<span class='adspan'>{address}</span>' is missing.<br/>Are you sure you want to use this address?",
        "emptyphrase": "Please enter your secret phrase",
        "notinwordlist": "{missing_word} not in wordlist",
        ...
        "nrchanges": "You have {nr_changes} changes in your app. Please backup your data.",
        "changein": "change in",
        ...
        "api_proxy": "API Proxy",
        "updateproxy": "Please update your proxy server {version} > {proxy_version}",
        ...
        "teaminviteharetitle": "Bitrequest Team invitation from {accountname}",
        "teamupdate": "Team update",
        "invitationexpiresin": "Invitation expires in",
        "installcompleted": "Installation already completed!",
        "teamup": "{account} wants to team up and make requests together with you!",
        "teamupdata": "{account} wants you to update bitrequest with his latest public keys",
        "clickinstall": "By clicking on install, bitrequest will be installed on your device with {account}'s public keys and restricted access.",
        // notifications
        "nameisrequired": "Name is required",
        "currencysaved": "Currency saved",
        "currencynotsupported": "currency '{currency}' not supported",
        "noiosbu": "Downloads for IOS App unavailable at the moment",
        "downloaded": "{file} gedownload",
        "filesize": "Filesize too big",
        "filetype": "Filetype '{filetype}' not supported",
        ...
        "unabletopost": "Unable to send Post request from {fixed_url}",
        "invalidapikey": "Invalid API key",
        "apicallerror": "API call error",
        "invalidapikeyname": "Invalid {thisref} API key",
        "addapikey": "Add {apisrc} Api key",
        "phname": "Name",
        "phaddress": "Address",
        ...
        "restorefromdevice": "Restore {file} from {device} device?",
        ...
        "apis": "APIs",
        "addapi": "Add {h_hint} RPC:",
        "websockets": "Websockets",
        "addwebsocket": "Add {h_hint} websocket:",
        "layer2": "Layer 2",
        "Xpub": "Xpub",
        "bip32xpub": "BIP32 Extended public key",
        "addxpub": "Add {currency} Xpub key",
        "xpubmatch": "The above addresses match those in my {currency} wallet.",
        ...
        "invalidxpub": "NOT a valid / supported {currency} Xpub key",
        "xpubsaved": "Xpub saved",
        "resetnotify": "{currency} settings reset to default",
        // confirm
        "reusewarningalert": "Are you sure you want to generate new {thiscurrency} addresses? they may not show up in some wallets.",
        "reusealert": "Are you sure you want to reuse {thiscurrency} addresses?",
        "confirmremovenode": "Are you sure you want to remove '{thisval}'?",
        "disablexpub": "Disable Xpub address derivation?",
        "replacexpub": "Replace Xpub?",
        "uselegacy": "Use {thiscurrency} Legacy addresses?",
        "usesegwit": "Use {thiscurrency} SegWit addresses?",
        "resetconfirm": "Are you sure you want to reset {currency} settings?",
        // dialog
        "resetdialog": "Reset {currency} settings?",
        ...
        "enterlnapikey": "Enter proxy API key to unlock '{proxy}'",
        "viewinvoice": "View invoice",
        "noinvoicesfound": "No invoices found.",
        "invoiceslocked": "Node proxy locked, unable to fetch invoices.<br/>Please enter your proxy <span id='pw_unlock_invoices' data-pid='{proxy_id}' class='ref'>API key</span>.",
        ...
        "defaultproxy": "{fixed_url} is a default proxy",
        "proxyexists": "Proxy already added",
        "invalidurl": "Invalid url",
        "selectimplementation": "Select implementation",
        "selectlnhost": "Select {imp} Host",
        "selectkeyname": "Select {impkeyname}",
        ...
        "proxyoffline": "Current node is offline, try {proxy_message} proxy",
        "folderpermissions": "Unable to write to cache, please check your folder permissions.",
        "proxyadded": "Proxy added",
        "unabletoconnectto": "Unable to connect to {value}",
        "proxynameexists": "{imp} node already added",
        "proxyinuse": "{imp}: '{name}' uses this proxy, remove it first",
        ...
        "disableproxy": "Disable proxy {set_proxy_val}?",
        "enableproxy": "Enable proxy {set_proxy_val}?",
        // dialog
        ...
        "minamount": "Minimum request amount is {min}",
        ...
        "addcoinaddress": "Add {currency} address",
        ...
        //DIALOGS
        "totalchanges": "You have {total_changes} changes in your app",
        "nochanges": "You have 0 changes in your app",
        "havewallet": "Do you have a {lnd_ref} wallet on this device?",
        ...
        "connecttolnur": "Connecting to {url}",
        "loadurl": "Loading {url}",
        "loading": "loading...",
        "gettokeninfo": "get token info",
        "checklightningstatus": "Check {imp} lightning status",
        "readingfromcache": "Reading {ccsymbol} rate from cache",
        "getccrates": "Get {ccsymbol} rates from {api}",
        "getfiatrates": "Get fiat rates",
        "readingfiatratesfromcache": "Reading fiat rates from cache",
        "fetchingfiatrates": "Fetching fiat rates from {fiatapi}",
        ...
        // CHECK INTENTS
        "proto": "{proto}: connect not available at the moment",
        "invalidurlscheme": "Invalid URL scheme",
        "usnotsupported": "URL scheme '{proto}:' is not supported",
...
function lang_en(id, data) {
    return lang_tl(lang_en_obj, id, data);
}